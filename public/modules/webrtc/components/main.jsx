...
class UserVideo extends React.Component {
  /**
   * Functions that modify UserVideo state, for example,
   * it mutes/unmutes the user audio or
   * pauses/unpauses the user video.
   */
  pause() {
...
class Video extends React.Component {
  ...
  render() {
    const stream = URL.createObjectURL(this.props.peer.stream);
...
class VideoStatus extends React.Component {
  ...
  componentDidMount() {
    ...
    /**
     * Callbacks when a remote user mutes/unmutes, if the
     * peer.id equals the peer passed by props then
